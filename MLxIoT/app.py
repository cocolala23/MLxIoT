...
model_path = 'KNN_Model_Fire.pkl'
cred_path = "iot-kebakaranhutan-firebase-adminsdk-qz2qj-9f79a86cab (1).json"
...
def fetch_sensor_data():
    ...
    try:
        ...
        return np.array([data['temp'], data['humidity'], data['soil_moisture']])
    except Exception as e:
